...
```bash
git remote add encore encore://reverse-verification-tool-ymo2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/reverse-verification-tool-ymo2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/reverse-verification-tool-ymo2/settings/integrations/github)
